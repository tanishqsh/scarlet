...
const Menu = [
  ...
  {
    displayName: 'About',
    subtitle: 'Why a conceptualization studio?',
    link: '/about',
  },
  {
    displayName: 'Services',
    subtitle: 'What all can we do together?',
    link: '/services',
  },
  {
    displayName: 'Clients',
    subtitle: 'You are in a good company.',
    link: '/clients',
  },
  {
    displayName: 'Mail Us',
    subtitle: 'hello@bescarlet.com',
    link: 'mailto:hello@bescarlet.com',
  },
  {
    displayName: 'Just a message away!',
    subtitle: 'Click to chat on WhatsApp',
    link:
      'https://api.whatsapp.com/send?phone=919769419289&text=Hey%20Scarlet!',
  },
];
